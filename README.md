...
*   [passagemath/passagemath](https://github.com/passagemath/passagemath) - General purpose mathematical software system, fork of SageMath supporting modularized installation with pip. Main repository, containing Sage library (src), modularized pip-installable packages (pkgs), Sage distribution (build)
